...
public class AppAnnotateIT {
  ...
  private static final String EXPECTED_VCF_OUTPUT =
      """
        ...
        chr2	0	.	N	NN	.	.	.
        chr2	166195200	.	C	G	.	.	FATHMM_MKL=0.169;gnomAD=T|0.0001|0|0|0||0.0942;ncER=58.0966;phyloP=-0.131;REMM=0.012;SpliceAI=6335|0|0|0|0||||
        chr2	166299171	.	A	<DEL>	.	.	SVLEN=3112
        chr2	166305791	.	C	T	.	.	FATHMM_MKL=0.996;gnomAD=T|0|0|0|0||0.9993;ncER=99.8932;phyloP=7.905;REMM=0.988;SpliceAI=6335|0|0|0|0.99||||1
        chr2	166305791	.	CG	C	.	.	ncER=99.9313;phyloP=8.143;REMM=0.992;SpliceAI=6335|0|0|1|0.99|||2|1
        chr2	166305792	.	G	A,C	.	.	FATHMM_MKL=0.996,0.996;gnomAD=T|0|0|0|0||0.9992,T|0|0|0|0||0.9992;ncER=99.9313,99.9313;phyloP=8.143,8.143;REMM=0.992,0.992;SpliceAI=6335|0|0|0.03|0|||2|,6335|0|0|0|0||||
        chr2	242193530	.	N	NN	.	.	.
        """;
  ...
  public void testAnnotate() throws URISyntaxException {
    ...
    Path inputVcfFile =
        Paths.get(
            classLoader
                .getResource("annotate/chr2_166195185-166375987/input_annotate.vcf")
                .toURI());
  ...
  @Test
  public void testReannotate() throws URISyntaxException {
    ClassLoader classLoader = getClass().getClassLoader();

    Path inputVcfFile =
        Paths.get(
            classLoader
                .getResource("annotate/chr2_166195185-166375987/input_reannotate.vcf")
                .toURI());
