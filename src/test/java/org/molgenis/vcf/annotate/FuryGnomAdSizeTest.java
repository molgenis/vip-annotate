...
public class FuryGnomAdSizeTest {
  ...
  public static void main(String[] args) {
    ...
    System.out.printf(
        "v1 min: %d bytes%n", fury.serialize(GnomAdShortVariantV1.createMin()).length); // 74 bytes
    System.out.printf(
        "v1 max: %d bytes%n", fury.serialize(GnomAdShortVariantV1.createMax()).length); // 98 bytes
    System.out.printf(
        "v2 min: %d bytes%n",
    ...
    System.out.printf(
        "v3 min: %d bytes%n", fury.serialize(GnomAdShortVariantV3.createMin()).length); // 38 bytes
    System.out.printf(
        "v3 max: %d bytes%n",
  ...
  public static class GnomAdShortVariantV1 extends ClosedInterval implements Serializable {
    ...
    public static GnomAdShortVariantV1 createMax() {
      return GnomAdShortVariantV1.builder()
          ...
          .exomesFilters(new FilterV1[] {FilterV1.AC0, FilterV1.AS_VQSR, FilterV1.INBREEDING_COEFF})
          .genomesFilters(
