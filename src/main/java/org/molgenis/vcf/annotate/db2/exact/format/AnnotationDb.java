...
public class AnnotationDb implements Closeable {
  private static final Logger LOGGER = LoggerFactory.getLogger(AnnotationDb.class);
  ...
  public AnnotationDb(File zipFile) throws IOException {
