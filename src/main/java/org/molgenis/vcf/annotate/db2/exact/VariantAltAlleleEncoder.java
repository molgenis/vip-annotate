...
public class VariantAltAlleleEncoder {
   ...
   * @param nrRefBases number of reference bases in the range [1,4]
   ...
   *
   * @param pos 1-based start position
   * @param nrRefBases number of reference bases
   * @param altBases alternate bases (each base must be one of A,C,G,T)
   * @return encoded variant
   */
