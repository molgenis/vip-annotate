...
public abstract class Field {
  ...
  /// Parses the field if it hasn't already been parsed. Subclasses should override [#onParse()] to
  ...
  /// Called by [#reset(CharSequence,int,int)]. Subclasses may override to clear internal state.
