...
public class NcERCommandArgsParser extends ArgsParser<NcERCommandArgs> {
  private static final String COMMAND = "ncer";

  @Override
  public NcERCommandArgs parse(String[] args) {
    ...
    return new NcERCommandArgs(inputFile, faiFile, outputFile);
  }
