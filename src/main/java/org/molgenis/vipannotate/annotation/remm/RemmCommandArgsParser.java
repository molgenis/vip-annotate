...
public class RemmCommandArgsParser extends ArgsParser<RemmCommandArgs> {
  private static final String COMMAND = "remm";

  @Override
  public RemmCommandArgs parse(String[] args) {
    ...
    return new RemmCommandArgs(inputFile, faiFile, outputFile);
  }
  ...
  protected void printUsage() {
    ...
    Logger.info(
        """
              ...
              usage: %s [arguments]
                -i, --input           FILE                input file, e.g. ReMM.v0.4.hg38.tsv.gz               (required)
