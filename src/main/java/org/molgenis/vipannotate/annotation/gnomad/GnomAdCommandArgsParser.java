...
public class GnomAdCommandArgsParser extends ArgsParser<GnomAdCommandArgs> {
  private static final String COMMAND = "gnomad";

  @Override
  public GnomAdCommandArgs parse(String[] args) {
    ...
    return new GnomAdCommandArgs(inputFile, faiFile, outputFile);
  }
  ...
  protected void printUsage() {
    ...
    Logger.info(
        """
              ...
              usage: %s [arguments]
                -i, --input           FILE     input file, e.g. gnomad.total.v4.1.sites.stripped-v2.tsv.gz (required)
