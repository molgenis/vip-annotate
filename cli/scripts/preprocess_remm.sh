...
usage: ${SCRIPT_NAME} [arguments]
  ...
  -i, --input   FILE  input 'ReMM.v0.4.hg38.tsv.gz' path         (required)
  ...
  see https://download.molgeniscloud.org/downloads/vip/resources/GRCh38/ReMM.v0.4.hg38.tsv.gz
  see https://download.molgeniscloud.org/downloads/vip/resources/GRCh38/ReMM.v0.4.hg38.tsv.gz.tbi
